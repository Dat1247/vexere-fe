...
export const UserManagementSlice = createSlice({
	...
	initialState: {
		...
		isSignUp: false,
		listUserType: [],
		listUser: listUserSeeder,
		listUserSearch: listUserSeeder,
		userEdit: {},
		userById: {},
		listTicketOfUser: [],
	...
	reducers: {
		...
		getListUserType: (state, action) => {
			state.listUserType = action.payload;
		},
		getUserById: (state, action) => {
			state.userById = action.payload;
		},
		getListTicketOfUser: (state, action) => {
			state.listTicketOfUser = action.payload;
		},
